...
def analyse_nba_game(play_by_play_moves):
    ...
    for play in play_by_play_moves:
        ...
        PERIOD = values[0]
        REMAINING_SEC = values[1]
        RELEVANT_TEAM = values[2]
        AWAY_TEAM = values[3]
        HOME_TEAM = values[4]
        AWAY_SCORE = values[5]
        HOME_SCORE = values[6]
...
play_by_play_moves = [1|708.00|GOLDEN_STATE_WARRIORS|OKLAHOMA_CITY_THUNDER|GOLDEN_STATE_WARRIORS|0|0|Turnover by K. Thompson (bad pass; steal by S. Adams),
